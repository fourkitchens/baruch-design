...
export default function HeaderMinimal() {
  ...
  return (
    <header className="bg-gradient-to-r from-primary-indigo to-primary-cuny-blue relative z-50">

      <div className="flex flex-row items-center lg:items-end justify-start py-7 max-width-wrapper">
