        ...
        <div className="xl:grid xl:grid-cols-5 xl:gap-8">
          ...
          <div className="mt-16 xl:mt-0 ms-auto xl:col-span-3">
            <div className="md:grid md:grid-cols-3 md:gap-8 md:divide-x md:divide-white/10 pt-2">
              <div className="pe-8">
                <h3 className="text-base font-semibold text-white">Explore Baruch</h3>
              ...
              <div className="mt-10 md:mt-0 pe-8">
                <h3 className="text-base font-semibold text-white">Support and Advocacy</h3>
                <ul role="list" className="mt-6 space-y-4">
              ...
              <div className="pe-8">
                <h3 className="text-base font-semibold text-white">Administrative Resources</h3>
                <ul role="list" className="mt-6 space-y-4">
