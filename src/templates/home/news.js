...
import featuredImage from '@/assets/images/home/Grad-school-student.gif';
        ...
        <div className="mt-8 grid grid-cols-5 gap-8 items-center">
          ...
          <div className="space-y-3 col-span-2">
            ...
            <h2 className="text-heading text-3xl font-semibold leading-normal">
              <a href="#" className="link">U.S. News & World Report Ranks Baruch Graduate Programs Among the Best in 2025</a>
            </h2>
            <p>Seven of the programs ranked—three from Zicklin and four from Marxe—placed #1 in New York City among public institutions, with each earning the top or second spot statewide.
            </p>
          </div>
        </div>
