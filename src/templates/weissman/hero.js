    ...
    <div className={clsx(
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-white text-center">
        <h1>
          ...
          <span className="text-2xl font-bold font-condensed uppercase text-shadow-lg/30 mb-2 text-balance block text-secondary-lemonade tracking-widest">School of Arts and Sciences</span>
        </h1>
      </div>
